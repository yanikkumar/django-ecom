...
class ProductFeaturedListView(ListView):                #class based view
...
class ProductFeaturedDetailView(ObjectViewedMixin, DetailView):                #class based view
...
class ProductDetailView(ObjectViewedMixin, DetailView):                #class based view
        # queryset = Product.objects.all()
        template_name = "products/detail.html"
